...
class Ui_ParseInterface(object):
    def setupUi(self, ParseInterface):
        ...
        self.goToSetUpBtn = PushButton(ParseInterface)
        self.goToSetUpBtn.setObjectName("goToSetUpBtn")
        self.horizontalLayout_3.addWidget(self.goToSetUpBtn)
    ...
    def retranslateUi(self, ParseInterface):
        ...
        self.goToSetUpBtn.setText(_translate("ParseInterface", "Go To Set Up"))
