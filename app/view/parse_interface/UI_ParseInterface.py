...
class Ui_ParseInterface(object):
    def setupUi(self, ParseInterface):
        ...
        self.websiteNameCombo.setIconSize(QtCore.QSize(16, 16))
        ...
        self.parsedOutput.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByMouse)
